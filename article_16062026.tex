...
of contaminant dynamics within organic-mineral matrices \cite{Xu2026}.
...
\cite{Raissi}---in which neural network flexibility is
...
expected to dominate next-generation soil contamination modelling \cite{Ma}.
